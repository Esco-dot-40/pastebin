...
router.get('/firebase-config', (req, res) => {
    // Use request host as authDomain so popup goes through our domain (proxied to Firebase)
    const host = req.get('x-forwarded-host') || req.get('host') || process.env.FIREBASE_AUTH_DOMAIN;
    res.json({
